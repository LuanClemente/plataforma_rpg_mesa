...
function GerenciarMonstros() {
  ...
  const fetchMonstros = async () => {
    ...
    try {
      ...
      const response = await fetch('http://https://plataforma-rpg-mesa.onrender.com/api/monstros');
      if (!response.ok) {
  ...
  const handleSubmitFormulario = async (e) => {
    ...
    const url = isEditing 
      ? `http://https://plataforma-rpg-mesa.onrender.com/api/monstros/${monstroEmEdicao.id}` // URL de Update
      : `http://https://plataforma-rpg-mesa.onrender.com/api/monstros`; // URL de Create
  ...
  const handleApagar = async (monstroId) => {
    ...
    if (window.confirm("Tem certeza que deseja apagar este monstro da base de dados?")) {
      try {
        const url = `http://https://plataforma-rpg-mesa.onrender.com/api/monstros/${monstroId}`;
