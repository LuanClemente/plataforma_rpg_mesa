...
function GerenciarItens() {
  ...
  const fetchItens = async () => {
    ...
    try {
      ...
      const response = await fetch('http://https://plataforma-rpg-mesa.onrender.com/api/itens');
      if (!response.ok) {
  ...
  const handleSubmitFormulario = async (e) => {
    ...
    const url = isEditing 
      ? `http://https://plataforma-rpg-mesa.onrender.com/api/itens/${itemEmEdicao.id}` // URL de Update
      : `http://https://plataforma-rpg-mesa.onrender.com/api/itens`; // URL de Create
  ...
  const handleApagar = async (itemId) => {
    if (window.confirm("Tem certeza que deseja apagar este item da base de dados?")) {
      try {
        const url = `http://https://plataforma-rpg-mesa.onrender.com/api/itens/${itemId}`;
